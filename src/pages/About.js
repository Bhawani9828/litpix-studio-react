...
function About() {
  return (
    <div>
      <div
        className='container-fluid mt-1 mt-lg-5 page-header wow fadeIn'
        data-wow-delay='0.1s'
        style={{
          visibility: "visible",
          animationDelay: "0.1s",
          ...
          <div className='row g-5'>
            ...
            >
              ...
              >
                ...
                />
                <img
                  className='position-absolute img-2 bg-white pe-3 pb-3'
            ...
            >
              <div className='h-100'>
                ...
                <h2 className=' mb-4'>
                  Broadband provider offers a higher- speed of data
                  transmission.
                </h2>
                <p>
                ...
                <div className='row g-2 mb-4 pb-2'>
                  <div className='col-sm-12'>
                    <i className='fa fa-check text-white border-white bg-danger border rounded-circle py-1 px-1 me-2' />
                ...
                <div className='row g-4'>
                  <div className='col-sm-4'>
                    <div className='video'>
                      <button
                        type='button'
                        className='btn-play border-0 bg-transparent'
                        data-bs-toggle='modal'
                        data-src='https://www.youtube.com/watch?v=D3pm1HHGLP0'
      ...
      <div className='container-xxl py-5 about_team'>
        <div className='container'>
          <div className='section-title text-center px-5'>
            <h6 className='text-primary text-uppercase mb-2 text-danger'>
              Our Creative Team
            </h6>
                ...
                <div className='overflow-hidden position-relative'>
                  ...
                  <div className='team-social'>
                    <a
                      ...
                      href
                    >
                      <i className='fab fa-facebook-f text-danger' />
                    </a>
                    <a
                      className='btn btn-square'
                      href
                    >
                      <i className='fab fa-twitter text-danger' />
                    </a>
                    <a
                      className='btn btn-square'
                      href
